...
public class StaffController {
	...
	public ModelAndView saveCustomer(@ModelAttribute NewStaff newStaff) {
		...
		// for now is known that admin staff is 1. In the future this code is expected
		// to be improved to pass the id from the url
		int staffId = 1;
		...
		if (!(addressId == 0) && (emailCheck == 0) && (usernameCheck == 0) && (phoneCheck == 0)) {
			...
			Staff staff = new Staff(0, firstName, surname, email, phone, jobTitle, username, password, birthDate,
					hireDate, addressId);
