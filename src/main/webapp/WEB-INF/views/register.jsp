			...
			<div class="container-fluid" id="surface">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a id="acolor" href="/GameCafe/register"><span
				...
				<div class="row">
					...
					<div class="col-sm-8 text-center" id="colback">
						...
						<div align="center" id="register">
							...
							<p>Sing up with us and have access to your booking
								information or book a table for your party!</p>
							<br>

							<form:form action="saveCustomer" method="post"
								modelAttribute="newCustomer" id="registerForm">
							...
							<button type="submit" form="registerForm" value="Save">Register</button>
