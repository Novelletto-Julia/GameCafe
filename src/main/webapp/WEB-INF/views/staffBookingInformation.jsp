					...
					<div class="col-sm-10 text-center" id="colback">
						...
						<div align="center" style="overflow-x: auto;">
							...
							<table>
								...
								<c:forEach var="bookingInformation" items="${viewAllBookings}"
									varStatus="status">
									<tr>

										<td>${bookingInformation.date}</td>
										<td>${bookingInformation.period}</td>
										<td class="text-center">${bookingInformation.bookingId}</td>
										<td>${bookingInformation.customerName}</td>
										<td class="text-center">${bookingInformation.foodService}</td>
										<td class="text-center">${bookingInformation.tableId}</td>
										<td class="text-center">${bookingInformation.bookingFee}
											&#8364;</td>
